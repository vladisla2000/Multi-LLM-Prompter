...
- v0.8.76: REVERTED v0.8.75 - the Grid wrapper made the header checkbox VANISH (a fixed-size Grid as
  DataGridColumnHeader content wasn't laid out within the small visible header band, so the centered box
  fell outside it). Restored the v0.8.74 bare 16x16 checkbox (visible = the best state reached). Open
