...
Текущая версия: **v0.8.56** (выпущена, ежедневный рабочий инструмент / daily driver).
Файл: `Multi-LLM-Prompter-v0_8_56.ps1` (~9 506 строк, ~416 КБ).
...
в GUI) -> v0.8.56 (строки версии в отчётах/баннере используют $ToolVersion).
...
`Multi-LLM-Prompter-v0_8_56.ps1` - ~9 506 строк. PS 5.1, исходник только ASCII (Unicode только как
