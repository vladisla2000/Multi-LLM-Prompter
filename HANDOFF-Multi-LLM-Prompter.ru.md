...
Текущая версия: **v0.8.61** (выпущена, ежедневный рабочий инструмент / daily driver).
Файл: `Multi-LLM-Prompter-v0_8_61.ps1` (~9 580 строк, ~416 КБ).
...
`Multi-LLM-Prompter-v0_8_61.ps1` - ~9 580 строк. PS 5.1, исходник только ASCII (Unicode только как
