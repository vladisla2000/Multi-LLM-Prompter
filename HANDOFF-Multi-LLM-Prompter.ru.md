...
Текущая версия: **v0.8.74** (выпущена, ежедневный рабочий инструмент / daily driver).
Файл: `Multi-LLM-Prompter-v0_8_74.ps1` (~10 420 строк, ~430 КБ).
...
`Multi-LLM-Prompter-v0_8_74.ps1` - ~10 420 строк. PS 5.1, исходник только ASCII (Unicode только как
