...
Текущая версия: **v0.8.75** (выпущена, ежедневный рабочий инструмент / daily driver).
Файл: `Multi-LLM-Prompter-v0_8_75.ps1` (~10 430 строк, ~430 КБ).
...
`Multi-LLM-Prompter-v0_8_75.ps1` - ~10 430 строк. PS 5.1, исходник только ASCII (Unicode только как
