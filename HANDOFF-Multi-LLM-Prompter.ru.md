...
Текущая версия: **v0.8.60** (выпущена, ежедневный рабочий инструмент / daily driver).
Файл: `Multi-LLM-Prompter-v0_8_60.ps1` (~9 560 строк, ~416 КБ).
...
`Multi-LLM-Prompter-v0_8_60.ps1` - ~9 560 строк. PS 5.1, исходник только ASCII (Unicode только как
...
- v0.8.60: полировка ясности первого запуска (часть 3, реструктуризация ввода). Тесная двухрядная
  ...
  ДАЛЕЕ (нужен живой GUI-проход): сворачиваемая quick-start карточка, empty-states для вкладок/очереди
  и объединение отдельной кнопки окна "Full Answer" в единое действие "View Answer".
