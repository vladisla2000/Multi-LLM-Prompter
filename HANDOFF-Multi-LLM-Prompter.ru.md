...
Текущая версия: **v0.8.58** (выпущена, ежедневный рабочий инструмент / daily driver).
Файл: `Multi-LLM-Prompter-v0_8_58.ps1` (~9 535 строк, ~416 КБ).
...
`Multi-LLM-Prompter-v0_8_58.ps1` - ~9 535 строк. PS 5.1, исходник только ASCII (Unicode только как
